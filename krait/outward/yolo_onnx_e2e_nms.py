...
def run(dirpath = "/data/raviprasad/scripts",
    ...
    predpath = os.path.join(dirpath, f"{predname}.bin")
    ...
    outpath = os.path.join(dirpath, f"{imgname}_CPPDETECT_PYTHONNMS.jpg")
...
parser.add_argument("-p", "--predname", type=str, help="name of the prediction numpy file (without extension)")
args = parser.parse_args()

if __name__ == "__main__":
    run(args.dirpath, args.imgname, args.modelname, args.predname)
